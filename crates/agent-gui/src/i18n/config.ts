...
export const translations: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "projectTools.gitReview.revealInFileTree": "在资源管理器视图中显示",
    ...
    "settings.remoteWebGitHint": "开启后，已登录 WebUI 可对本机项目执行分支、暂存、提交和同步操作。",
  ...
  "en-US": {
    ...
    "settings.remoteWebGitHint": "Allow authenticated WebUI clients to run branch, stage, commit, and sync operations on local projects.",
