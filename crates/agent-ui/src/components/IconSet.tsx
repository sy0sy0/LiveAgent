...
import BracketsSource from "~icons/lucide/brackets";
...
import Columns2Source from "~icons/lucide/columns-2";
...
import FlameSource from "~icons/lucide/flame";
...
import HandSource from "~icons/lucide/hand";
...
import MicSource from "~icons/lucide/mic";
...
import PawPrintSource from "~icons/lucide/paw-print";
...
import ShieldOffSource from "~icons/lucide/shield-off";
...
export const Brackets = createIcon(BracketsSource);
...
export const Columns2 = createIcon(Columns2Source);
...
export const Flame = createIcon(FlameSource);
...
export const Hand = createIcon(HandSource);
...
export const Home = createIcon(HouseSource);
...
export const Mic = createIcon(MicSource);
...
export const PawPrint = createIcon(PawPrintSource);
...
export const ShieldOff = createIcon(ShieldOffSource);
