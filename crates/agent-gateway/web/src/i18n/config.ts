...
export const translations: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "settings.memoryQuotaDegraded": "记忆配额吃紧：{scope} 已用 {used}/{limit}，请运行记忆整理进行压缩。",
    "settings.memoryQuotaCritical": "记忆配额告急：{scope} 已用 {used}/{limit}，新记忆可能很快无法写入。",
    "settings.memoryQuotaExhausted": "记忆配额已满：{scope} 已用 {used}/{limit}，请立即整理或删除记忆。",
