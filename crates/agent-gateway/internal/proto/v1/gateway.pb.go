...
const file_proto_v1_gateway_proto_rawDesc = "" +
	...
	"\n" +
	"session_id\x18\x03 \x01(\tR\tsessionId\"\x8b\x1e\n" +
	...
	"\x17managed_process_request\x18[ \x01(\v2+.liveagent.gateway.v1.ManagedProcessRequestH\x00R\x15managedProcessRequestB\t\n" +
	"\apayloadJ\x04\bC\x10DJ\x04\bD\x10EJ\x04\bE\x10FJ\x04\bJ\x10K\"\xfd'\n" +
...
var file_proto_v1_gateway_proto_goTypes = []any{
	...
	(*HistoryPinRequest)(nil),                 // 74: liveagent.gateway.v1.HistoryPinRequest
	(*HistoryPinResponse)(nil),                // 75: liveagent.gateway.v1.HistoryPinResponse
	(*HistoryShareStatus)(nil),                // 76: liveagent.gateway.v1.HistoryShareStatus
	(*HistoryShareGetRequest)(nil),            // 77: liveagent.gateway.v1.HistoryShareGetRequest
	(*HistoryShareGetResponse)(nil),           // 78: liveagent.gateway.v1.HistoryShareGetResponse
	(*HistoryShareSetRequest)(nil),            // 79: liveagent.gateway.v1.HistoryShareSetRequest
	(*HistoryShareSetResponse)(nil),           // 80: liveagent.gateway.v1.HistoryShareSetResponse
	(*HistoryShareResolveRequest)(nil),        // 81: liveagent.gateway.v1.HistoryShareResolveRequest
	(*HistoryShareResolveResponse)(nil),       // 82: liveagent.gateway.v1.HistoryShareResolveResponse
	(*HistoryWorkdirsRequest)(nil),            // 83: liveagent.gateway.v1.HistoryWorkdirsRequest
	(*HistoryWorkdirSummary)(nil),             // 84: liveagent.gateway.v1.HistoryWorkdirSummary
	(*HistoryWorkdirsResponse)(nil),           // 85: liveagent.gateway.v1.HistoryWorkdirsResponse
	(*HistoryDeleteRequest)(nil),              // 86: liveagent.gateway.v1.HistoryDeleteRequest
	(*HistoryDeleteResponse)(nil),             // 87: liveagent.gateway.v1.HistoryDeleteResponse
	(*HistorySyncEvent)(nil),                  // 88: liveagent.gateway.v1.HistorySyncEvent
	(*ProviderListRequest)(nil),               // 89: liveagent.gateway.v1.ProviderListRequest
	(*ProviderListResponse)(nil),              // 90: liveagent.gateway.v1.ProviderListResponse
	(*SettingsGetRequest)(nil),                // 91: liveagent.gateway.v1.SettingsGetRequest
	(*SettingsGetResponse)(nil),               // 92: liveagent.gateway.v1.SettingsGetResponse
	(*SettingsUpdateRequest)(nil),             // 93: liveagent.gateway.v1.SettingsUpdateRequest
	(*SettingsUpdateResponse)(nil),            // 94: liveagent.gateway.v1.SettingsUpdateResponse
	(*SettingsResetSshKnownHostRequest)(nil),  // 95: liveagent.gateway.v1.SettingsResetSshKnownHostRequest
	(*SettingsResetSshKnownHostResponse)(nil), // 96: liveagent.gateway.v1.SettingsResetSshKnownHostResponse
	(*SettingsSyncEvent)(nil),                 // 97: liveagent.gateway.v1.SettingsSyncEvent
	(*SkillFilesListRequest)(nil),             // 98: liveagent.gateway.v1.SkillFilesListRequest
	(*SkillFilesListResponse)(nil),            // 99: liveagent.gateway.v1.SkillFilesListResponse
	(*SkillMetadataReadRequest)(nil),          // 100: liveagent.gateway.v1.SkillMetadataReadRequest
	(*SkillMetadataReadResponse)(nil),         // 101: liveagent.gateway.v1.SkillMetadataReadResponse
	(*SkillTextReadRequest)(nil),              // 102: liveagent.gateway.v1.SkillTextReadRequest
	(*SkillTextReadResponse)(nil),             // 103: liveagent.gateway.v1.SkillTextReadResponse
	(*SkillManageRequest)(nil),                // 104: liveagent.gateway.v1.SkillManageRequest
	(*SkillManageResponse)(nil),               // 105: liveagent.gateway.v1.SkillManageResponse
	(*FileMentionListRequest)(nil),            // 106: liveagent.gateway.v1.FileMentionListRequest
	(*FileMentionEntry)(nil),                  // 107: liveagent.gateway.v1.FileMentionEntry
	(*FileMentionListResponse)(nil),           // 108: liveagent.gateway.v1.FileMentionListResponse
	(*FsRoot)(nil),                            // 109: liveagent.gateway.v1.FsRoot
	(*FsRootsRequest)(nil),                    // 110: liveagent.gateway.v1.FsRootsRequest
	(*FsRootsResponse)(nil),                   // 111: liveagent.gateway.v1.FsRootsResponse
	(*FsListDirsRequest)(nil),                 // 112: liveagent.gateway.v1.FsListDirsRequest
	(*FsDirEntry)(nil),                        // 113: liveagent.gateway.v1.FsDirEntry
	(*FsListDirsResponse)(nil),                // 114: liveagent.gateway.v1.FsListDirsResponse
	(*FsCreateProjectFolderRequest)(nil),      // 115: liveagent.gateway.v1.FsCreateProjectFolderRequest
	(*FsCreateProjectFolderResponse)(nil),     // 116: liveagent.gateway.v1.FsCreateProjectFolderResponse
	(*FsListRequest)(nil),                     // 117: liveagent.gateway.v1.FsListRequest
	(*FsListEntry)(nil),                       // 118: liveagent.gateway.v1.FsListEntry
	(*FsListResponse)(nil),                    // 119: liveagent.gateway.v1.FsListResponse
	(*FsReadEditableTextRequest)(nil),         // 120: liveagent.gateway.v1.FsReadEditableTextRequest
	(*FsReadEditableTextResponse)(nil),        // 121: liveagent.gateway.v1.FsReadEditableTextResponse
	(*FsReadWorkspaceImageRequest)(nil),       // 122: liveagent.gateway.v1.FsReadWorkspaceImageRequest
	(*FsReadWorkspaceImageResponse)(nil),      // 123: liveagent.gateway.v1.FsReadWorkspaceImageResponse
	(*FsWriteTextRequest)(nil),                // 124: liveagent.gateway.v1.FsWriteTextRequest
	(*FsWriteTextResponse)(nil),               // 125: liveagent.gateway.v1.FsWriteTextResponse
	(*FsCreateDirRequest)(nil),                // 126: liveagent.gateway.v1.FsCreateDirRequest
	(*FsCreateDirResponse)(nil),               // 127: liveagent.gateway.v1.FsCreateDirResponse
	(*FsRenameRequest)(nil),                   // 128: liveagent.gateway.v1.FsRenameRequest
	(*FsRenameResponse)(nil),                  // 129: liveagent.gateway.v1.FsRenameResponse
	(*FsDeleteRequest)(nil),                   // 130: liveagent.gateway.v1.FsDeleteRequest
	(*FsDeleteResponse)(nil),                  // 131: liveagent.gateway.v1.FsDeleteResponse
	(*PingRequest)(nil),                       // 132: liveagent.gateway.v1.PingRequest
	(*PongResponse)(nil),                      // 133: liveagent.gateway.v1.PongResponse
	(*ErrorResponse)(nil),                     // 134: liveagent.gateway.v1.ErrorResponse
}
var file_proto_v1_gateway_proto_depIdxs = []int32{
	...
	86,  // 5: liveagent.gateway.v1.GatewayEnvelope.history_delete:type_name -> liveagent.gateway.v1.HistoryDeleteRequest
	70,  // 6: liveagent.gateway.v1.GatewayEnvelope.history_prefix:type_name -> liveagent.gateway.v1.HistoryPrefixRequest
	74,  // 7: liveagent.gateway.v1.GatewayEnvelope.history_pin:type_name -> liveagent.gateway.v1.HistoryPinRequest
	77,  // 8: liveagent.gateway.v1.GatewayEnvelope.history_share_get:type_name -> liveagent.gateway.v1.HistoryShareGetRequest
	79,  // 9: liveagent.gateway.v1.GatewayEnvelope.history_share_set:type_name -> liveagent.gateway.v1.HistoryShareSetRequest
	81,  // 10: liveagent.gateway.v1.GatewayEnvelope.history_share_resolve:type_name -> liveagent.gateway.v1.HistoryShareResolveRequest
	83,  // 11: liveagent.gateway.v1.GatewayEnvelope.history_workdirs:type_name -> liveagent.gateway.v1.HistoryWorkdirsRequest
	89,  // 12: liveagent.gateway.v1.GatewayEnvelope.provider_list:type_name -> liveagent.gateway.v1.ProviderListRequest
	91,  // 13: liveagent.gateway.v1.GatewayEnvelope.settings_get:type_name -> liveagent.gateway.v1.SettingsGetRequest
	93,  // 14: liveagent.gateway.v1.GatewayEnvelope.settings_update:type_name -> liveagent.gateway.v1.SettingsUpdateRequest
	98,  // 15: liveagent.gateway.v1.GatewayEnvelope.skill_files_list:type_name -> liveagent.gateway.v1.SkillFilesListRequest
	100, // 16: liveagent.gateway.v1.GatewayEnvelope.skill_metadata_read:type_name -> liveagent.gateway.v1.SkillMetadataReadRequest
	102, // 17: liveagent.gateway.v1.GatewayEnvelope.skill_text_read:type_name -> liveagent.gateway.v1.SkillTextReadRequest
	106, // 18: liveagent.gateway.v1.GatewayEnvelope.file_mention_list:type_name -> liveagent.gateway.v1.FileMentionListRequest
	...
	110, // 20: liveagent.gateway.v1.GatewayEnvelope.fs_roots:type_name -> liveagent.gateway.v1.FsRootsRequest
	112, // 21: liveagent.gateway.v1.GatewayEnvelope.fs_list_dirs:type_name -> liveagent.gateway.v1.FsListDirsRequest
	132, // 22: liveagent.gateway.v1.GatewayEnvelope.ping:type_name -> liveagent.gateway.v1.PingRequest
	...
	104, // 25: liveagent.gateway.v1.GatewayEnvelope.skill_manage:type_name -> liveagent.gateway.v1.SkillManageRequest
	115, // 26: liveagent.gateway.v1.GatewayEnvelope.fs_create_project_folder:type_name -> liveagent.gateway.v1.FsCreateProjectFolderRequest
	34,  // 27: liveagent.gateway.v1.GatewayEnvelope.terminal_request:type_name -> liveagent.gateway.v1.TerminalRequest
	117, // 28: liveagent.gateway.v1.GatewayEnvelope.fs_list:type_name -> liveagent.gateway.v1.FsListRequest
	124, // 29: liveagent.gateway.v1.GatewayEnvelope.fs_write_text:type_name -> liveagent.gateway.v1.FsWriteTextRequest
	126, // 30: liveagent.gateway.v1.GatewayEnvelope.fs_create_dir:type_name -> liveagent.gateway.v1.FsCreateDirRequest
	128, // 31: liveagent.gateway.v1.GatewayEnvelope.fs_rename:type_name -> liveagent.gateway.v1.FsRenameRequest
	130, // 32: liveagent.gateway.v1.GatewayEnvelope.fs_delete:type_name -> liveagent.gateway.v1.FsDeleteRequest
	49,  // 33: liveagent.gateway.v1.GatewayEnvelope.git_request:type_name -> liveagent.gateway.v1.GitRequest
	120, // 34: liveagent.gateway.v1.GatewayEnvelope.fs_read_editable_text:type_name -> liveagent.gateway.v1.FsReadEditableTextRequest
	122, // 35: liveagent.gateway.v1.GatewayEnvelope.fs_read_workspace_image:type_name -> liveagent.gateway.v1.FsReadWorkspaceImageRequest
	37,  // 36: liveagent.gateway.v1.GatewayEnvelope.sftp_request:type_name -> liveagent.gateway.v1.SftpRequest
	95,  // 37: liveagent.gateway.v1.GatewayEnvelope.settings_reset_ssh_known_host:type_name -> liveagent.gateway.v1.SettingsResetSshKnownHostRequest
	...
	58,  // 44: liveagent.gateway.v1.AgentEnvelope.chat_event:type_name -> liveagent.gateway.v1.ChatEvent
	64,  // 45: liveagent.gateway.v1.AgentEnvelope.cron_manage_resp:type_name -> liveagent.gateway.v1.CronManageResponse
	66,  // 46: liveagent.gateway.v1.AgentEnvelope.history_list_resp:type_name -> liveagent.gateway.v1.HistoryListResponse
	69,  // 47: liveagent.gateway.v1.AgentEnvelope.history_get_resp:type_name -> liveagent.gateway.v1.HistoryGetResponse
	73,  // 48: liveagent.gateway.v1.AgentEnvelope.history_rename_resp:type_name -> liveagent.gateway.v1.HistoryRenameResponse
	87,  // 49: liveagent.gateway.v1.AgentEnvelope.history_delete_resp:type_name -> liveagent.gateway.v1.HistoryDeleteResponse
	88,  // 50: liveagent.gateway.v1.AgentEnvelope.history_sync:type_name -> liveagent.gateway.v1.HistorySyncEvent
	71,  // 51: liveagent.gateway.v1.AgentEnvelope.history_prefix_resp:type_name -> liveagent.gateway.v1.HistoryPrefixResponse
	75,  // 52: liveagent.gateway.v1.AgentEnvelope.history_pin_resp:type_name -> liveagent.gateway.v1.HistoryPinResponse
	78,  // 53: liveagent.gateway.v1.AgentEnvelope.history_share_get_resp:type_name -> liveagent.gateway.v1.HistoryShareGetResponse
	80,  // 54: liveagent.gateway.v1.AgentEnvelope.history_share_set_resp:type_name -> liveagent.gateway.v1.HistoryShareSetResponse
	82,  // 55: liveagent.gateway.v1.AgentEnvelope.history_share_resolve_resp:type_name -> liveagent.gateway.v1.HistoryShareResolveResponse
	85,  // 56: liveagent.gateway.v1.AgentEnvelope.history_workdirs_resp:type_name -> liveagent.gateway.v1.HistoryWorkdirsResponse
	90,  // 57: liveagent.gateway.v1.AgentEnvelope.provider_list_resp:type_name -> liveagent.gateway.v1.ProviderListResponse
	92,  // 58: liveagent.gateway.v1.AgentEnvelope.settings_get_resp:type_name -> liveagent.gateway.v1.SettingsGetResponse
	94,  // 59: liveagent.gateway.v1.AgentEnvelope.settings_update_resp:type_name -> liveagent.gateway.v1.SettingsUpdateResponse
	97,  // 60: liveagent.gateway.v1.AgentEnvelope.settings_sync:type_name -> liveagent.gateway.v1.SettingsSyncEvent
	99,  // 61: liveagent.gateway.v1.AgentEnvelope.skill_files_list_resp:type_name -> liveagent.gateway.v1.SkillFilesListResponse
	101, // 62: liveagent.gateway.v1.AgentEnvelope.skill_metadata_read_resp:type_name -> liveagent.gateway.v1.SkillMetadataReadResponse
	103, // 63: liveagent.gateway.v1.AgentEnvelope.skill_text_read_resp:type_name -> liveagent.gateway.v1.SkillTextReadResponse
	108, // 64: liveagent.gateway.v1.AgentEnvelope.file_mention_list_resp:type_name -> liveagent.gateway.v1.FileMentionListResponse
	12,  // 65: liveagent.gateway.v1.AgentEnvelope.upload_readable_files_resp:type_name -> liveagent.gateway.v1.UploadReadableFilesResponse
	111, // 66: liveagent.gateway.v1.AgentEnvelope.fs_roots_resp:type_name -> liveagent.gateway.v1.FsRootsResponse
	133, // 67: liveagent.gateway.v1.AgentEnvelope.pong:type_name -> liveagent.gateway.v1.PongResponse
	114, // 68: liveagent.gateway.v1.AgentEnvelope.fs_list_dirs_resp:type_name -> liveagent.gateway.v1.FsListDirsResponse
	14,  // 69: liveagent.gateway.v1.AgentEnvelope.uploaded_image_preview_resp:type_name -> liveagent.gateway.v1.UploadedImagePreviewResponse
	33,  // 70: liveagent.gateway.v1.AgentEnvelope.memory_manage_resp:type_name -> liveagent.gateway.v1.MemoryManageResponse
	105, // 71: liveagent.gateway.v1.AgentEnvelope.skill_manage_resp:type_name -> liveagent.gateway.v1.SkillManageResponse
	116, // 72: liveagent.gateway.v1.AgentEnvelope.fs_create_project_folder_resp:type_name -> liveagent.gateway.v1.FsCreateProjectFolderResponse
	46,  // 73: liveagent.gateway.v1.AgentEnvelope.terminal_response:type_name -> liveagent.gateway.v1.TerminalResponse
	47,  // 74: liveagent.gateway.v1.AgentEnvelope.terminal_event:type_name -> liveagent.gateway.v1.TerminalEvent
	119, // 75: liveagent.gateway.v1.AgentEnvelope.fs_list_resp:type_name -> liveagent.gateway.v1.FsListResponse
	125, // 76: liveagent.gateway.v1.AgentEnvelope.fs_write_text_resp:type_name -> liveagent.gateway.v1.FsWriteTextResponse
	127, // 77: liveagent.gateway.v1.AgentEnvelope.fs_create_dir_resp:type_name -> liveagent.gateway.v1.FsCreateDirResponse
	129, // 78: liveagent.gateway.v1.AgentEnvelope.fs_rename_resp:type_name -> liveagent.gateway.v1.FsRenameResponse
	131, // 79: liveagent.gateway.v1.AgentEnvelope.fs_delete_resp:type_name -> liveagent.gateway.v1.FsDeleteResponse
	50,  // 80: liveagent.gateway.v1.AgentEnvelope.git_response:type_name -> liveagent.gateway.v1.GitResponse
	121, // 81: liveagent.gateway.v1.AgentEnvelope.fs_read_editable_text_resp:type_name -> liveagent.gateway.v1.FsReadEditableTextResponse
	123, // 82: liveagent.gateway.v1.AgentEnvelope.fs_read_workspace_image_resp:type_name -> liveagent.gateway.v1.FsReadWorkspaceImageResponse
	40,  // 83: liveagent.gateway.v1.AgentEnvelope.sftp_response:type_name -> liveagent.gateway.v1.SftpResponse
	41,  // 84: liveagent.gateway.v1.AgentEnvelope.sftp_event:type_name -> liveagent.gateway.v1.SftpEvent
	56,  // 85: liveagent.gateway.v1.AgentEnvelope.chat_queue_resp:type_name -> liveagent.gateway.v1.ChatQueueResponse
	57,  // 86: liveagent.gateway.v1.AgentEnvelope.chat_queue_event:type_name -> liveagent.gateway.v1.ChatQueueEvent
	59,  // 87: liveagent.gateway.v1.AgentEnvelope.chat_control:type_name -> liveagent.gateway.v1.ChatControlEvent
	61,  // 88: liveagent.gateway.v1.AgentEnvelope.runtime_status:type_name -> liveagent.gateway.v1.RuntimeStatusEvent
	96,  // 89: liveagent.gateway.v1.AgentEnvelope.settings_reset_ssh_known_host_resp:type_name -> liveagent.gateway.v1.SettingsResetSshKnownHostResponse
	60,  // 90: liveagent.gateway.v1.AgentEnvelope.chat_runtime_snapshot:type_name -> liveagent.gateway.v1.ChatRuntimeSnapshot
	...
	27,  // 95: liveagent.gateway.v1.AgentEnvelope.workspace_activity:type_name -> liveagent.gateway.v1.WorkspaceActivityEvent
	31,  // 96: liveagent.gateway.v1.AgentEnvelope.managed_process_response:type_name -> liveagent.gateway.v1.ManagedProcessResponse
	29,  // 97: liveagent.gateway.v1.AgentEnvelope.managed_process_snapshot:type_name -> liveagent.gateway.v1.ManagedProcessSnapshot
	134, // 98: liveagent.gateway.v1.AgentEnvelope.error:type_name -> liveagent.gateway.v1.ErrorResponse
	10,  // 99: liveagent.gateway.v1.UploadReadableFilesRequest.files:type_name -> liveagent.gateway.v1.UploadReadableFile
	9,   // 100: liveagent.gateway.v1.UploadReadableFilesResponse.files:type_name -> liveagent.gateway.v1.ChatUploadedFile
	15,  // 101: liveagent.gateway.v1.TunnelDesiredState.tunnels:type_name -> liveagent.gateway.v1.TunnelSpec
	17,  // 102: liveagent.gateway.v1.TunnelStatus.local:type_name -> liveagent.gateway.v1.TunnelHealth
	18,  // 103: liveagent.gateway.v1.TunnelStateSnapshot.tunnels:type_name -> liveagent.gateway.v1.TunnelStatus
	17,  // 104: liveagent.gateway.v1.TunnelStateSnapshot.relay:type_name -> liveagent.gateway.v1.TunnelHealth
	17,  // 105: liveagent.gateway.v1.TunnelProbeResult.local:type_name -> liveagent.gateway.v1.TunnelHealth
	22,  // 106: liveagent.gateway.v1.TunnelProbeReport.results:type_name -> liveagent.gateway.v1.TunnelProbeResult
	0,   // 107: liveagent.gateway.v1.TunnelFrame.kind:type_name -> liveagent.gateway.v1.TunnelFrameKind
	24,  // 108: liveagent.gateway.v1.TunnelFrame.headers:type_name -> liveagent.gateway.v1.TunnelHeader
	1,   // 109: liveagent.gateway.v1.TunnelFrame.ws_message_type:type_name -> liveagent.gateway.v1.TunnelWsMessageType
	28,  // 110: liveagent.gateway.v1.ManagedProcessSnapshot.processes:type_name -> liveagent.gateway.v1.ManagedProcessRecord
	29,  // 111: liveagent.gateway.v1.ManagedProcessResponse.snapshot:type_name -> liveagent.gateway.v1.ManagedProcessSnapshot
	36,  // 112: liveagent.gateway.v1.TerminalSession.ssh:type_name -> liveagent.gateway.v1.TerminalSshMetadata
	38,  // 113: liveagent.gateway.v1.SftpResponse.entries:type_name -> liveagent.gateway.v1.SftpEntry
	38,  // 114: liveagent.gateway.v1.SftpResponse.entry:type_name -> liveagent.gateway.v1.SftpEntry
	39,  // 115: liveagent.gateway.v1.SftpResponse.transfer:type_name -> liveagent.gateway.v1.SftpTransfer
	39,  // 116: liveagent.gateway.v1.SftpEvent.transfer:type_name -> liveagent.gateway.v1.SftpTransfer
	44,  // 117: liveagent.gateway.v1.TerminalSshTabsSnapshot.tabs:type_name -> liveagent.gateway.v1.TerminalSshTab
	35,  // 118: liveagent.gateway.v1.TerminalResponse.sessions:type_name -> liveagent.gateway.v1.TerminalSession
	35,  // 119: liveagent.gateway.v1.TerminalResponse.session:type_name -> liveagent.gateway.v1.TerminalSession
	43,  // 120: liveagent.gateway.v1.TerminalResponse.shell_options:type_name -> liveagent.gateway.v1.TerminalShellOption
	42,  // 121: liveagent.gateway.v1.TerminalResponse.ssh_prompt:type_name -> liveagent.gateway.v1.TerminalSshPrompt
	45,  // 122: liveagent.gateway.v1.TerminalResponse.ssh_tabs:type_name -> liveagent.gateway.v1.TerminalSshTabsSnapshot
	35,  // 123: liveagent.gateway.v1.TerminalEvent.session:type_name -> liveagent.gateway.v1.TerminalSession
	45,  // 124: liveagent.gateway.v1.TerminalEvent.ssh_tabs:type_name -> liveagent.gateway.v1.TerminalSshTabsSnapshot
	35,  // 125: liveagent.gateway.v1.TerminalStreamFrame.session:type_name -> liveagent.gateway.v1.TerminalSession
	7,   // 126: liveagent.gateway.v1.ChatRequest.selected_model:type_name -> liveagent.gateway.v1.ChatSelectedModel
	9,   // 127: liveagent.gateway.v1.ChatRequest.uploaded_files:type_name -> liveagent.gateway.v1.ChatUploadedFile
	8,   // 128: liveagent.gateway.v1.ChatRequest.runtime_controls:type_name -> liveagent.gateway.v1.ChatRuntimeControls
	51,  // 129: liveagent.gateway.v1.ChatCommandRequest.request:type_name -> liveagent.gateway.v1.ChatRequest
	52,  // 130: liveagent.gateway.v1.ChatCommandRequest.base_message_ref:type_name -> liveagent.gateway.v1.ChatMessageRef
	53,  // 131: liveagent.gateway.v1.ChatCommandRequest.cancel:type_name -> liveagent.gateway.v1.CancelChatRequest
	2,   // 132: liveagent.gateway.v1.ChatEvent.type:type_name -> liveagent.gateway.v1.ChatEvent.ChatEventType
	62,  // 133: liveagent.gateway.v1.RuntimeStatusEvent.active_runs:type_name -> liveagent.gateway.v1.ChatRunReport
	62,  // 134: liveagent.gateway.v1.RuntimeStatusEvent.finished_runs:type_name -> liveagent.gateway.v1.ChatRunReport
	67,  // 135: liveagent.gateway.v1.HistoryListResponse.conversations:type_name -> liveagent.gateway.v1.ConversationSummary
	67,  // 136: liveagent.gateway.v1.HistoryGetResponse.conversation:type_name -> liveagent.gateway.v1.ConversationSummary
	52,  // 137: liveagent.gateway.v1.HistoryPrefixRequest.base_message_ref:type_name -> liveagent.gateway.v1.ChatMessageRef
	67,  // 138: liveagent.gateway.v1.HistoryPrefixResponse.conversation:type_name -> liveagent.gateway.v1.ConversationSummary
	67,  // 139: liveagent.gateway.v1.HistoryRenameResponse.conversation:type_name -> liveagent.gateway.v1.ConversationSummary
	67,  // 140: liveagent.gateway.v1.HistoryPinResponse.conversation:type_name -> liveagent.gateway.v1.ConversationSummary
	76,  // 141: liveagent.gateway.v1.HistoryShareGetResponse.share:type_name -> liveagent.gateway.v1.HistoryShareStatus
	76,  // 142: liveagent.gateway.v1.HistoryShareSetResponse.share:type_name -> liveagent.gateway.v1.HistoryShareStatus
	67,  // 143: liveagent.gateway.v1.HistoryShareResolveResponse.conversation:type_name -> liveagent.gateway.v1.ConversationSummary
	84,  // 144: liveagent.gateway.v1.HistoryWorkdirsResponse.workdirs:type_name -> liveagent.gateway.v1.HistoryWorkdirSummary
	67,  // 145: liveagent.gateway.v1.HistorySyncEvent.conversation:type_name -> liveagent.gateway.v1.ConversationSummary
	107, // 146: liveagent.gateway.v1.FileMentionListResponse.entries:type_name -> liveagent.gateway.v1.FileMentionEntry
	109, // 147: liveagent.gateway.v1.FsRootsResponse.roots:type_name -> liveagent.gateway.v1.FsRoot
	113, // 148: liveagent.gateway.v1.FsListDirsResponse.entries:type_name -> liveagent.gateway.v1.FsDirEntry
	118, // 149: liveagent.gateway.v1.FsListResponse.entries:type_name -> liveagent.gateway.v1.FsListEntry
	6,   // 150: liveagent.gateway.v1.AgentGateway.AgentConnect:input_type -> liveagent.gateway.v1.AgentEnvelope
	48,  // 151: liveagent.gateway.v1.AgentGateway.AgentTerminalConnect:input_type -> liveagent.gateway.v1.TerminalStreamFrame
	3,   // 152: liveagent.gateway.v1.AgentGateway.Authenticate:input_type -> liveagent.gateway.v1.AuthRequest
	5,   // 153: liveagent.gateway.v1.AgentGateway.AgentConnect:output_type -> liveagent.gateway.v1.GatewayEnvelope
	48,  // 154: liveagent.gateway.v1.AgentGateway.AgentTerminalConnect:output_type -> liveagent.gateway.v1.TerminalStreamFrame
	4,   // 155: liveagent.gateway.v1.AgentGateway.Authenticate:output_type -> liveagent.gateway.v1.AuthResponse
